...
def calculate_CHG(fuel_consumed):
    multipication_factor = 3.114
    CHG_consumed = fuel_consumed * multipication_factor
...
path = 'ais-hourly-2022-08-01-2022-08-30.json'
...
Fuel_consumed = 370
Total_chg = calculate_CHG(Fuel_consumed)
print(f"{Total_chg}kg")
